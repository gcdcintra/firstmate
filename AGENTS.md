...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks .turnend-claude-blocks.lock .turnend-standdown-blocks .turnend-standdown-blocks.lock   Claude Stop auto-arm single-flight, epoch, failure-episode, attended-alarm, guard-budget, and budget-lock records, plus the guard's own bounded counter for the stood-down outcome (another live session owns the fleet lock); never touch

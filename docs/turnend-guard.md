...
An owner whose fork continuity simply could not be proven does reach it, so the banner and the alarm name the recorded pid and both readings - a second live session, or this session's own displaced predecessor - instead of asserting either.

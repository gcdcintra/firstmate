...
An absence is absorbed to the triage log when the worker already reported a terminal outcome, or when a declared pause or captain hold already owns the exited-agent case on its own bounded recheck cadence.

...
FM_CPU_PROGRESS_MAX_DEFER_SECS=7200   # per-pane budget for how long measured CPU progress may defer one pane's wedge escalation; spent once, after which the pane escalates on the FM_STALE_ESCALATE_SECS cadence until it goes genuinely active again

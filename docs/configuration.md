...
FM_CPU_PROGRESS_WINDOW=45          # shortest worker-CPU sampling window trusted for a verdict; a shorter one is scheduler noise and returns unknown, which escalates
